...
function groupArticlesByYearAndMonth(articles: Article[]) {
  return articles.reduce((years: { [key: string]: { [key: string]: Article[] } }, article) => {
...
export default function BlogSidebar({ articles }: BlogSidebarProps) {
  ...
  return (
    <aside className="w-64 pr-6 border-r border-cLineBreak">
